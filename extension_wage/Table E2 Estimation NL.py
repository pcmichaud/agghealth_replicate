...
if far:
	...
	guess = [-1.390735980477975530789080949035, 3.992195860481596358937395052635,
		0.989482478392771591657606222725, 0.657279652842471917573163864290]
...
df.to_pickle('output/params_wage_nl.pkl')
