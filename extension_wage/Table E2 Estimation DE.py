...
if far:
	...
	guess = [-1.282523002141444434798245310958,  4.029535044721018977043058839627,
		1.011022759893204225889462577470,  0.836301090330201057909675910196]
...
df.to_pickle('output/params_wage_de.pkl')
