...
if far:
	guess = [-1.6, 4.2, 1.2, .95]
else :
	guess = [-1.602087748740246508916129641875, 4.273079789076208001574741501827,
		1.260592121908874707614245380682, 0.888409196774689435827099259768]
...
df.to_pickle('output/params_wage_dk.pkl')
